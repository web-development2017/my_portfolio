    ...
    <header className="gcc-nav">
        <nav className="navbar navbar-expand-xl" id="nav-custom">
            ...
            <div className="navbar-collapse" id="main_nav">
                ...
                <ul className="gcc-ul navbar-nav mb-4 mb-xl-0 mr-auto">
                    ...
                    <li className="nav-item">
                        <a onClick={pd} href="https://github.com/" className="nav-link">Team</a>
                    </li>

                    <li className="nav-item">
                        <a onClick={pd} href="https://github.com/" className="nav-link">Enterprise</a>
                    </li>

                    <li className="nav-item dropdown">
                        <a onClick={pd} href="https://github.com/" className="nav-link dropdown-toggle" id="navbarDropdown1" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            Explore
                        </a>
                        <div className="dropdown-menu" aria-labelledby="navbarDropdown1">
                            <a onClick={pd} href="https://github.com/" className="dropdown-header dropdown-item">Explore GitHub</a>
                            <div className="dropdown-divider"></div>
                            <h4>Learn and contribute</h4>
                            <a onClick={pd} href="https://github.com/" className="dropdown-item">Topics</a>
                            <a onClick={pd} href="https://github.com/" className="dropdown-item">Collections</a>
                            <a onClick={pd} href="https://github.com/" className="dropdown-item">Trending</a>
                            <a onClick={pd} href="https://github.com/" className="dropdown-item">Learning lab</a>
                            <a onClick={pd} href="https://github.com/" className="dropdown-item">Open sourse guides</a>
                            <div className="dropdown-divider"></div>
                            <h4>Connect with others</h4>
                            <a onClick={pd} href="https://github.com/" className="dropdown-item">Events</a>
                            <a onClick={pd} href="https://github.com/" className="dropdown-item">Comunnity forum</a>
                            <a onClick={pd} href="https://github.com/" className="dropdown-item">GitHub Education</a>
                        </div>
                    </li>

                    <li className="nav-item">
                        <a onClick={pd} href="https://github.com/" className="nav-link">Marketplace</a>
                    </li>

                    <li className="nav-item dropdown">
                        <a onClick={pd} href="https://github.com/" className="nav-link dropdown-toggle" id="navbarDropdown2" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            Pricing
                        </a>
                        <div className="dropdown-menu" aria-labelledby="navbarDropdown2">
                            <a onClick={pd} href="https://github.com/" className="dropdown-header dropdown-item">Plans</a>
                            <a onClick={pd} href="https://github.com/" className="dropdown-item">Compare plans</a>
                            <a onClick={pd} href="https://github.com/" className="dropdown-item">Contact sales</a>
                            <div className="dropdown-divider"></div>
                            <a onClick={pd} href="https://github.com/" className="dropdown-header dropdown-item">Non profit</a>
                            <a onClick={pd} href="https://github.com/" className="dropdown-header dropdown-item">Education</a>
                        </div>
                    </li>
                </ul>

                <form className="form-inline my-2 my-lg-0">
                    <input className="form-control mr-sm-2 mb-3 mb-xl-0" type="search" placeholder="Search GitHub"/>
                    <button onClick={pd} className="btn btn-dark my-2 my-sm-0" id="signIn" type="submit">Sign In</button>
                    <button onClick={pd} className="btn btn-outline-custom my-2 my-sm-0" id="mobileSignUp" type="submit">Sign Up</button>
                </form>
